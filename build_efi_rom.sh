...
cd Build
chmod +x EfiRom
./EfiRom -e pc-ultra-1-2-IntelGopDriver.efi nb-ultra-155h.efi nb-ultra-255h.efi IntelGopDriver.efi IgdAssignmentDxe.efi PlatformGopPolicy.efi -f 0x8086 -i 0xffff -o ultra-1-2-qemu10.rom
ls
